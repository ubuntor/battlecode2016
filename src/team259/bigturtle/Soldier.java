...
//            	System.out.println("!!");
            ...
            patrol[0] = tlArchon.add(Direction.NORTH_WEST, 3);
            patrol[1] = tlArchon.add(Direction.NORTH_EAST, 3);
            patrol[2] = tlArchon.add(Direction.SOUTH_EAST, 3);
            patrol[3] = tlArchon.add(Direction.SOUTH_WEST, 3);
            if(numArchons > 1){
